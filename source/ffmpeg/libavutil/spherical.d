...
struct AVSphericalMapping
{
     ...
     * @endcode
     */
    int yaw; ///< Rotation around the up vector [-180, 180].
    int pitch; ///< Rotation around the right vector [-90, 90].
    int roll; ///< Rotation around the forward vector [-180, 180].
    /**
     * @}
     */
     ...
     */
    uint bound_left; ///< Distance from the left edge
    uint bound_top; ///< Distance from the top edge
    uint bound_right; ///< Distance from the right edge
    uint bound_bottom; ///< Distance from the bottom edge
    /**
     * @}
     */
