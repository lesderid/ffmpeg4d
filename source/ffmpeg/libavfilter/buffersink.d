 ...
 */
enum AV_BUFFERSINK_FLAG_NO_REQUEST = 2;
...
{
    const(AVPixelFormat)* pixel_fmts; ///< list of allowed pixel formats, terminated by AV_PIX_FMT_NONE
}
...
{
    const(AVSampleFormat)* sample_fmts; ///< list of allowed sample formats, terminated by AV_SAMPLE_FMT_NONE
    const(long)* channel_layouts; ///< list of allowed channel layouts, terminated by -1
